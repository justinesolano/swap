                                                    ...
                                                    <div className="form-group col-xl-12">
                                                        <div className="media align-items-center mb-3">
                                                            <img className="mr-3 rounded-circle mr-0 mr-sm-3"
                                                                src={require('./../../images/juicy-icon-alt.svg')} width="55" height="55" alt="" />
                                                            <div className="media-body">
                                                                <h4 className="mb-0">Juicy Investor</h4>
                                            ...
                                            <form method="post" name="myform" className="personal_validate">
                                                <div className="form-row">
                                                    <div className="form-group col-xl-6">
                                                        <label className="mr-sm-2">Your Name</label>
                                                        <input type="text" className="form-control" placeholder="Juicy Investor"
                                                            name="fullname" />
                                                    </div>
                                                    <div className="form-group col-xl-6">
